...
export const AuthPage = ()=>{
    ...
    const loginHandler = async ()=>{
            try{
                ...
                if(data.status === 202){
                    context.login(data.user, data.accessT, data.refreshT)
                }else{
                ...
                <div style={{width:"450px", margin: "auto"}}>
                    ...
                    <div className="card  grey lighten-4 box2" style={{marginBottom: "5rem"}}>
                        <div className="card-content black-text">
                            <strong className="title">Authentication</strong>
                        ...
                        <div className="card-action">
                            <button className="btn white-text bold bttn" onClick={loginHandler} disabled={loading}>Sign in</button>
                            <div className="right">
